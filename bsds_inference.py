...
if __name__ == '__main__':
    ...
    parser.add_argument('--jpeg_inputs_dir', type=str, required=True)
    ...
    if not os.path.exists(opt.jpeg_inputs_dir):
        os.makedirs(opt.outputs_dir)
    ...
    input.save(os.path.join(opt.jpeg_inputs_dir, '{}_jpeg_q{}.png'.format(filename, opt.jpeg_quality)))
